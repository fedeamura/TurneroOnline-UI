      ...
      <React.Fragment>
        <Grid container spacing={32} direction="row">
          ...
          <Grid item xs={12} sm={8}>
            {this.props.data.ubicaciones != undefined && this.props.data.ubicaciones.length != 0 && (
              <div>
                ...
                {this.props.data.ubicaciones.map((ubicacion, index) => {
                  ...
                  let urlMapa = `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${lng}&zoom=17&scale=false&size=300x300&maptype=roadmap&key=${
          ...
          <Grid item xs={12} sm={4}>
            {this.props.data.links != undefined && this.props.data.links.length != 0 && (
          ...
          {/* Requisitos */}
          {this.props.data.requisitos != undefined && this.props.data.requisitos.length != 0 && (
            <Grid item xs={12}>
                ...
                {this.props.data.requisitos.map((requisito, index) => {
                  return (
                    <div key={index} className={classNames("contenedorRequisito")}>
                      ...
                      {requisito.links != undefined && requisito.links.length != 0 && (
          ...
          {/* Personas asociadas */}
          {this.props.data.usuariosAsociados != undefined && this.props.data.usuariosAsociados.length != 0 && (
            <Grid item xs={12}>
